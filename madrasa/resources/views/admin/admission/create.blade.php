    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
                    ...
                    <div class="page-header">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">ছাত্রী ভর্তি</a>
                                    </li>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 style="color: maroon;" class="card-header text-center">ভর্তি ফর্ম</h5>
                        <div class="card-body">
                            <form action="{{ url('/admissions/') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2 pt-2">
                                        ...
                                        <input type="text" class="form-control" name="admissionfee">
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2 pt-2">
