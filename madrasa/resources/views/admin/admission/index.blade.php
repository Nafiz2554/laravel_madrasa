            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                    <div class="page-header">
                        <h2 style="color: maroon; font-weight:bold;" class="pageheader-title">সকল ভর্তিকৃত ছাত্রী</h2>
                                    ...
                                    @foreach ($admissions as $admission)
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $admission->formfee }} </td>
                                                <td>{{ $admission->admissionfee }} </td>
                                                <td>{{ $admission->idcardfee }} </td>
                                                <td>{{ $admission->resulltcardfee }} </td>
                                                <td>{{ $admission->monthlykhoraki }} </td>
                                                <td>{{ $admission->residentialfee }} </td>
                                                <td>{{ $admission->nonresidentialfee }} </td>
                                                <td>{{ $admission->boardregistrationfee }} </td>
                                                <td>{{ $admission->examfee }} </td>
                                                <td>{{ $admission->sanadfee }} </td>
                                                <td>{{ $admission->protoyonfee }} </td>
                                                <td>{{ $admission->moallimafee }} </td>
                                                <td>{{ $admission->currentbill }} </td>
                                                <td>{{ $admission->boyeka }} </td>
                                                <td>{{ $admission->bibidh }} </td>
                                                <td>{{ $admission->total }} /- Taka</td>
                                                <td><a target="_blank" href="{{ url('money-recipt/' . $admission->id) }}"
                                                        class="btn btn-primary"><i class="fa fa-print"></i></a></td>
                                                <td><button type="button" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModal{{ $admission->id }}"
                                                        class="btn btn-warning"><i class="fa fa-edit"></i></button></td>
                                                <td><a href=" " class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                </td>
                                                <td>
                                                    <form action="{{ url('/admission-delete/' . $admission->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
